    ...
    <Table>
      <TableHead>
        <TableRow>
          ...
          <TableCell width={50}>Win</TableCell>
          <TableCell width={50}>Lose</TableCell>
          <TableCell width={50}>Draw</TableCell>
          <TableCell width={50}>Score</TableCell>
        </TableRow>
      </TableHead>
      <TableBody>
        {team?.teams &&
          sortedArray.map((item, index) => {
            return (
              ...
              >
                <TableCell className={index < 3 ? "td-border" : ""}>{index + 1}</TableCell>
                <TableCell>
                  <TeamItem team={team.teams[item.id]} sx={{ justifyContent: "left" }} />
                </TableCell>
