    ...
    <Grid container spacing={2} rowSpacing={4}>
      <Grid item xs={12}>
        ...
        <Box display={"flex"} justifyContent={"center"} gap={4} alignItems={"center"} mt={2}>
          <Box display={"flex"} justifyContent={"center"} gap={2}>
            ...
            <Box width={"200px"} height={"200px"} textAlign={"center"}>
              <img src={inputs.darkLogo || config.DEFAULT_LOGO} style={{ height: "200px", maxWidth: "200px", objectFit: "contain" }} />
            </Box>
          </Box>
          <Box display={"flex"} justifyContent={"center"} gap={2}>
            <Box display={"flex"} flexDirection={"column"} gap={2} alignItems={"baseline"}>
            ...
            <Box width={"200px"} height={"200px"} textAlign={"center"}>
              <img src={inputs.lightLogo || config.DEFAULT_LOGO} style={{ height: "200px", maxWidth: "200px", objectFit: "contain" }} />
            </Box>
          </Box>
        </Box>
        ...
        <Box sx={{ textAlign: "center", position: "relative", mt: 3 }}>
          ...
          <img src={inputs?.banner || config.DEFAULT_CONTENTBLOCK_IMAGE} style={{ height: "200px", maxWidth: "600px", objectFit: "cover", border: "solid 1px rgba(255, 255, 255, 0.2)", borderRadius: "4px" }} />
        </Box>
      </Grid>
        ...
        <Box sx={{ mt: 3 }}>
          ...
          <FormControl fullWidth sx={{ mt: 1 }}>
            {/* <TextField multiline id="event-description" name="description" aria-describedby="event-description-helper" value={inputs?.description} disabled={disabled}
              onChange={handle.inputs} /> */}
            <RichTextInput content={inputs?.description}
      ...
      <Grid item xs={12} lg={6}>
        ...
        <FormControl sx={{ mt: 1 }} fullWidth error={errors.prize !== undefined}>
          <OutlinedInput id="prize-pool" name="prize" aria-describedby="prize-pool-helper" value={inputs?.prize} disabled={disabled}
            type="number" onChange={handle.inputs} startAdornment={
              <InputAdornment position='start'>
                $
              </InputAdornment>
            } />
          {errors.prize !== undefined && <FormHelperText id="prize-pool-helper" sx={{ mt: 2 }}>{errors.prize}</FormHelperText>}
        </FormControl>
      </Grid>
      ...
      <Grid item xs={12} lg={6}>
        ...
        <FormControl sx={{ mt: 1 }} fullWidth error={errors.entryFee !== undefined}>
          <OutlinedInput id="entry-fee" name="entryFee" aria-describedby="entry-fee-helper" value={inputs?.entryFee} disabled={disabled}
            type="number" onChange={handle.inputs} startAdornment={
              <InputAdornment position='start'>
                $
              </InputAdornment>
            } />
          {errors.entryFee !== undefined && <FormHelperText id="check-in-helper" sx={{ mt: 2 }}>{errors.entryFee}</FormHelperText>}
        </FormControl>
      </Grid>
